jQuery.sap.require("suppliers.util.Formatter");
jQuery.sap.require("suppliers.util.Controller");

suppliers.util.Controller.extend("suppliers.view.Detail", {
	...
	onRouteMatched: function(oEvent) {
		...
		jQuery.when(this.oInitialLoadFinishedDeferred).then(jQuery.proxy(function() {
			...
			oIconTabBar.getItems().forEach(function(oItem) {
				oItem.bindElement(suppliers.util.Formatter.uppercaseFirstChar(oItem.getKey()));
			});
	...
	showEmptyView: function() {
		this.getRouter().myNavToWithoutHash({
			...
			targetViewName: "suppliers.view.NotFound",
			targetViewType: "XML"
		});
	},
