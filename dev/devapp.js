jQuery.sap.declare("suppliers.dev.devapp");
jQuery.sap.require("suppliers.dev.devlogon");

suppliers.dev.devapp = {
	smpInfo: {},
	externalURL: null,
		...
		if (window.sap_webide_FacadePreview) {
			...
			$.getJSON(".project.json", function(data) {
				...
				if (that.smpInfo.server && that.smpInfo.server.length > 0) {
					...
					that.devLogon = new suppliers.dev.devlogon();
