jQuery.sap.declare("suppliers.Component");
jQuery.sap.require("suppliers.MyRouter");

sap.ui.core.UIComponent.extend("suppliers.Component", {
	metadata: {
		name: "TDG Demo App",
		version: "1.0",
		includes: [],
		...
		rootView: "suppliers.view.App",

		config: {
			resourceBundle: "i18n/messageBundle.properties",
			serviceConfig: {
				name: "NorthwindModel",
				serviceUrl: "/destinations/Northwind/V2/Northwind/Northwind.svc/"
			}
		},

		routing: {
			config: {
				routerClass: suppliers.MyRouter,
				viewType: "XML",
				viewPath: "suppliers.view",
	...
	init: function() {
		...
		var oRootPath = jQuery.sap.getModulePath("suppliers");
		...
		var oModel;
		var externalURL = suppliers.dev.devapp.externalURL;
		var appContext;
		if (suppliers.dev.devapp.devLogon) {
			appContext = suppliers.dev.devapp.devLogon.appContext;
		}
